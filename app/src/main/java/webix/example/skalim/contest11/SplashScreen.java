...
import webix.example.skalim.contest11.ImageUtils;
import webix.example.skalim.contest11.ResizeCallbackImageView;
...
public class SplashScreen{
    ...
    public SplashScreen(Activity activity, ActionBar actionBar) {
    ...
    private void replaceRootContent(Activity activity) {
        ...
        mSplashContainer = (ViewGroup) LayoutInflater.from(content.getContext())
                .inflate(R.layout.activity_splash_screen, null, false);
    ...
    private void initViews() {
        ...
        mSplashBackgroundColor = ContextCompat.getColor(mContext, R.color.dark);
        mSplashImage = ContextCompat.getDrawable(mContext, R.drawable.cricket);
    ...
    public static class Builder {
        private SplashScreen mSplashInstance;

        public Builder(Activity activity, ActionBar actionBar) {
            mSplashInstance = new SplashScreen(activity, actionBar);
        }
        ...
        public Builder setOneShotStart(boolean isOneShot) {
            SplashScreen.isOneShot = isOneShot;
            return this;
        }
