...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder>
{
    ...
    public RecyclerAdapter(Context context,ArrayList text1,ArrayList text3,int[] resources1,int[] resources2) {
        this.text1 = text1;
        this.text3 = text3;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            text1=(TextView)itemView.findViewById(R.id.tv_num);
...
public class RecyclerAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerAdapter(TabActivity_1 context, ArrayList name, ArrayList image) {
