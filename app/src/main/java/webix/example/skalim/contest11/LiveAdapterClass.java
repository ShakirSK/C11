...
public class LiveAdapterClass extends RecyclerView.Adapter<LiveAdapterClass.MyViewHolder>
{
    ArrayList text1;
    ArrayList text3;
    Context context;
    ...
    public LiveAdapterClass(Context context,ArrayList text1,ArrayList text3,int[] resources1,int[] resources2) {
        this.text1 = text1;
        this.text3 = text3;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.livetabitems,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClick(View v, int pos) {
                ...
                Log.d("itemcliked", String.valueOf(text1.get(position)) + "    "+ String.valueOf(text3.get(position)));

                Intent i=new Intent(context,Contest11InnerPage.class);
...
/*
public class LiveAdapterClass extends RecyclerView.Adapter {
    ArrayList name, image;
    TabActivity_1 context;

    public LiveAdapterClass(TabActivity_1 context, ArrayList name, ArrayList image) {
...
/*
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new LiveAdapterClass.MyViewHolder(view);
    }
