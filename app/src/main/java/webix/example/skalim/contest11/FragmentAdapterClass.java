...
public class FragmentAdapterClass extends RecyclerView.Adapter<FragmentAdapterClass.MyViewHolder>
{
    ...
    public FragmentAdapterClass(Context context,ArrayList text1,ArrayList text3,int[] resources1,int[] resources2) {
        this.text1 = text1;
        this.text3 = text3;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClick(View v, int pos) {
                ...
                //INTENT OBJ
             /*   Intent i=new Intent(context,TabActivity_4.class);
                i.putExtra("first", text2);
                i.putExtra("second", text4);*/
...
/*
public class FragmentAdapterClass extends RecyclerView.Adapter {
    ArrayList name, image;
    TabActivity_1 context;

    public FragmentAdapterClass(TabActivity_1 context, ArrayList name, ArrayList image) {
...
/*
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FragmentAdapterClass.MyViewHolder(view);
    }
